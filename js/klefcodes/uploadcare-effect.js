    ...
    if (modifierRegExp[settingsEffect]) {
      ...
      if (foundModifier) {
        ...
        if (settingsEffect === 'crop') {
          ...
          var cropIndex = settingsCrop.findIndex(function (_ref) {
            var _ref$preferedSize = slicedToArray(_ref.preferedSize, 2),
                w = _ref$preferedSize[0],
                h = _ref$preferedSize[1];
...
var buildFileInfoCrop = function buildFileInfoCrop(_ref) {
